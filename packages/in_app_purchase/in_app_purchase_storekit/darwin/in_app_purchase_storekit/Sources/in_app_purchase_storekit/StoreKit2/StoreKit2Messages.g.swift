...
struct SK2ProductPurchaseOptionsMessage: Hashable, CustomStringConvertible {
  ...
  func hash(into hasher: inout Hasher) {
    ...
    StoreKit2MessagesPigeonInternal.deepHash(value: introductoryOfferEligibilityCompactJWS, hasher: &hasher)
  }

  public var description: String {
    return "SK2ProductPurchaseOptionsMessage(appAccountToken: \(String(describing: appAccountToken)), quantity: \(String(describing: quantity)), promotionalOffer: \(String(describing: promotionalOffer)), winBackOfferId: \(String(describing: winBackOfferId)), introductoryOfferEligibilityCompactJWS: \(String(describing: introductoryOfferEligibilityCompactJWS)))"
  }
}
...
struct SK2TransactionMessage: Hashable, CustomStringConvertible {
  ...
  var originalPurchaseDate: Double? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> SK2TransactionMessage? {
    ...
    let originalPurchaseDate: Double? = nilOrValue(pigeonVar_list[4])
    let expirationDate: Double? = nilOrValue(pigeonVar_list[5])
    let purchasedQuantity = pigeonVar_list[6] as! Int64
    let appAccountToken: String? = nilOrValue(pigeonVar_list[7])
    ...
    let status = pigeonVar_list[11] as! SK2PurchaseStatusMessage
  ...
  static func == (lhs: SK2TransactionMessage, rhs: SK2TransactionMessage) -> Bool {
    ...
    return StoreKit2MessagesPigeonInternal.deepEquals(lhs.id, rhs.id) && StoreKit2MessagesPigeonInternal.deepEquals(lhs.originalId, rhs.originalId) && StoreKit2MessagesPigeonInternal.deepEquals(lhs.productId, rhs.productId) && StoreKit2MessagesPigeonInternal.deepEquals(lhs.purchaseDate, rhs.purchaseDate) && StoreKit2MessagesPigeonInternal.deepEquals(lhs.originalPurchaseDate, rhs.originalPurchaseDate) && StoreKit2MessagesPigeonInternal.deepEquals(lhs.expirationDate, rhs.expirationDate) && StoreKit2MessagesPigeonInternal.deepEquals(lhs.purchasedQuantity, rhs.purchasedQuantity) && StoreKit2MessagesPigeonInternal.deepEquals(lhs.appAccountToken, rhs.appAccountToken) && StoreKit2MessagesPigeonInternal.deepEquals(lhs.receiptData, rhs.receiptData) && StoreKit2MessagesPigeonInternal.deepEquals(lhs.error, rhs.error) && StoreKit2MessagesPigeonInternal.deepEquals(lhs.jsonRepresentation, rhs.jsonRepresentation) && StoreKit2MessagesPigeonInternal.deepEquals(lhs.status, rhs.status)
  }
  ...
  func hash(into hasher: inout Hasher) {
    ...
    StoreKit2MessagesPigeonInternal.deepHash(value: originalPurchaseDate, hasher: &hasher)
  ...
  public var description: String {
    return "SK2TransactionMessage(id: \(String(describing: id)), originalId: \(String(describing: originalId)), productId: \(String(describing: productId)), purchaseDate: \(String(describing: purchaseDate)), originalPurchaseDate: \(String(describing: originalPurchaseDate)), expirationDate: \(String(describing: expirationDate)), purchasedQuantity: \(String(describing: purchasedQuantity)), appAccountToken: \(String(describing: appAccountToken)), receiptData: \(String(describing: receiptData)), error: \(String(describing: error)), jsonRepresentation: \(String(describing: jsonRepresentation)), status: \(String(describing: status)))"
  }
}
